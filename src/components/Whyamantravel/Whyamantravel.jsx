  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 py-10 text-sm">
      <div className="container mx-auto px-4 grid gap-8">
        ...
        <div>
          <h3 className="font-bold text-base mb-3">Airlines</h3>
          <p>{makeLinks("Indigo, Emirates, Spicejet, Air India, Air India Express, Vistara, Biman Bangladesh, Gulf Air, Qatar Airways, Etihad Airways, Flydubai, Kuwait Airways, Oman Air, Thai Airways, Royal Nepal Airlines, Turkish Airlines, Srilankan Airlines, Air Arabia, Airblue")}</p>
        </div>

        <div>
          <h3 className="font-bold text-base mb-3">Product Offering</h3>
          <p>{makeLinks("Book Flights From UAE, Book Hotels From UAE")}</p>

          <h3 className="font-bold text-base mt-6 mb-3">About the Site</h3>
          <p>{makeLinks("Contact Us, Privacy Policy, Cookie Policy, User Agreement, Terms of Service")}</p>
        </div>
      </div>

      {/* Gap Removed - Directly Touching Footer */}
<div className="w-full bg-gray-200 dark:bg-gray-800 p-8 md:p-16 lg:p-24 grid md:grid-cols-2 gap-16 text-sm mt-[60px] mb-[-40px]">
  <div>
    <h2 className="text-lg font-bold mb-6">Why Aman’s Escapades?</h2>
  ...
  <div>
    <h2 className="text-lg font-bold mb-6">Booking Flights with Aman’s Escapades</h2>
    <p className="text-gray-800 dark:text-gray-200">
