...
<div  className="w-full bg-gray-200 dark:bg-gray-800 p-8 md:p-16 lg:p-24 grid md:grid-cols-2 gap-16 text-sm mt-[60px] mb-[-40px]">
  <div>
    <h2  data-aos="fade-up" className="text-lg font-bold mb-6">Why Aman’s Escapades?</h2>
    <p   data-aos="fade-up"className="text-gray-800 dark:text-gray-200">
  ...
  <div>
    <h2  data-aos="fade-up" className="text-lg font-bold mb-6">Booking Flights with Aman’s Escapades</h2>
    <p  data-aos="fade-up"className="text-gray-800 dark:text-gray-200">
